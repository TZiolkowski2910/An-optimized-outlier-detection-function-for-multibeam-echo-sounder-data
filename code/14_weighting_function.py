...
# Load the dataset
df = pd.read_feather('/data6/tziolkowski/oqf/correct/grids/statisticbased/grids/chunk_14.6195--29.278.feather')
...
df.to_feather('/data6/tziolkowski/oqf/correct/grids/statisticbased/grids/combined_predictions_weightedscore_1.feather')
