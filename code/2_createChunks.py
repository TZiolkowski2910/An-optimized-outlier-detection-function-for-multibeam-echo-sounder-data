...
df = pd.read_feather('/data6/tziolkowski/oqf/correct/grids/statisticbased/combined_predictions.feather')  # Replace 'multibeam_data.csv' with your file name
...
output_dir = '/data6/tziolkowski/oqf/correct/grids/statisticbased/grids'
