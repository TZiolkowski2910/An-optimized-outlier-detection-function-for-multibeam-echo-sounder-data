...
file_names = [f for f in os.listdir(dir_path) if f.startswith('combined_predictions_weightedscore_')]
...
combined_df.to_feather('/data6/tziolkowski/oqf/correct/grids/statisticbased/grids/combined_predictions_test_evaluation.feather')
