...
#combined_file_path = '/data6/tziolkowski/oqf/eval/mlp_with_predictions_spatialsplit.feather'
combined_file_path = '/data6/tziolkowski/oqf/eval3135/chunks/OTD_features_eval.feather'
...
results_df.to_csv('/data6/tziolkowski/oqf/eval3135/outlier_results_3135.csv', index=False)
