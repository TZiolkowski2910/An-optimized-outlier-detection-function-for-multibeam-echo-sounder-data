...
df = pd.read_feather('/data6/tziolkowski/data/raw_txt/running_example/combinedFeather')  # Replace 'multibeam_data.csv' with your file name
...
output_dir = '/data6/tziolkowski/data/raw_txt/running_example/chunks'
